...
class GAN(object):
    def __init__(self, img_shape = IMG_SHAPE, train_type = 'normal' ,noise_shape = 1000, train_data_size = 0.5, batch_size = 256, buffer_size = 60000, generator_loss = generator_loss, discriminator_loss = discriminator_loss, discriminator_type = 'discriminator'):
